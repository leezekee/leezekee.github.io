import{_ as i,o as n,c as d,e,b as l,f as s}from"./app-81f005e5.js";const t={},r=l("p",null,"无意刷到这几道题，既然都看到了，哪有不做的道理",-1),a=s(`<p>首先说明，本文采用的例子均为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        1
       / \\
      2   3
     / \\ / \\
    4  5 6  7
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>未完...</p>`,12);function c(v,u){return n(),d("div",null,[r,e(" more "),a,e(" TODO ")])}const m=i(t,[["render",c],["__file","树的深度相关问题.html.vue"]]);export{m as default};
