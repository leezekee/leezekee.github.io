import{_ as p,r as e,o as i,c as u,a as n,b as s,d as t,e as o}from"./app-8ce60001.js";const l={},c=n("p",null,[s("某天刷视频刷到用U盘打造多合一多功能U盘，突发奇想，去咸鱼捡了一块256G的2230硬盘，又上pdd买了一个2230硬盘盒，准备搞一个包含了Windows TOGO、Linux TOGO的一个启动盘，写这篇文章就是为了记录下过程，以供以后参考（"),n("s",null,"我太清楚我的记忆能力了，不过十天保准忘的干干净净"),s("）")],-1),r=n("h2",{id:"准备",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#准备","aria-hidden":"true"},"#"),s(" 准备")],-1),d={href:"https://blog.upx8.com/2477",target:"_blank",rel:"noopener noreferrer"},k=n("li",null,"任意linux发行版，我这里用的是Ubuntu22.04",-1),v={href:"https://bbs.luobotou.org/forum.php?mod=viewthread&tid=6098",target:"_blank",rel:"noopener noreferrer"},q={href:"https://www.virtualbox.org/wiki/Downloads",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.ventoy.net/cn/download.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/ventoy/vhdiso/releases",target:"_blank",rel:"noopener noreferrer"},g={href:"https://github.com/ventoy/vtoyboot/releases",target:"_blank",rel:"noopener noreferrer"},y=o('<h2 id="windows-to-go" tabindex="-1"><a class="header-anchor" href="#windows-to-go" aria-hidden="true">#</a> Windows To Go</h2><p>首先打开WTG辅助工具，选择镜像路径，再选择安装的位置，一定看准硬盘是不是要安装的那一块</p><p>然后可以按照如图配置</p><figure><img src="https://image.zekee.top/blog/20231102233852.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>这里的屏蔽本机磁盘我没有开启，开启之后在wintogo中就没办法看到本机的其他磁盘的内容了</p></blockquote><figure><img src="https://image.zekee.top/blog/20231102234312.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><blockquote><p>我的硬盘是256G的，所以我分了100G给了wintogo这里因人而异，但也不建议小于60G</p></blockquote>',7),_={href:"https://bbs.luobotou.org/forum.php?mod=viewthread&tid=6098",target:"_blank",rel:"noopener noreferrer"},h=o('<p>完成后重启，选择从这块硬盘启动并完成wintogo的初始化，这步一定要有，否则会系统无法启动</p><p>之后将硬盘中的wtg.vhdx拷贝出来备用</p><h2 id="linux-to-go" tabindex="-1"><a class="header-anchor" href="#linux-to-go" aria-hidden="true">#</a> Linux To go</h2><p>打开VirtualBox，新建虚拟机</p><p>文件夹改为你要放虚拟机信息的地址，虚拟光盘设为系统镜像文件</p><figure><img src="https://image.zekee.top/blog/20231102235358.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>这里一定要启用EFI</p><figure><img src="https://image.zekee.top/blog/20231102235527.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>选择一个保存vdi的位置，这个要记好，然后大小看自己，一般为40G，当然你要空间比较大，随意就好，一定要选上预先分配全部空间</p><figure><img src="https://image.zekee.top/blog/20231102235701.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',10),f=n("code",null,"vtoyboot.iso",-1),w={href:"https://blog.csdn.net/qq997404392/article/details/79611606",target:"_blank",rel:"noopener noreferrer"},x={href:"https://zhuanlan.zhihu.com/p/389629976",target:"_blank",rel:"noopener noreferrer"},O=n("p",null,[s("然后在虚拟机中解压得到"),n("code",null,"vtoyboot.sh"),s("，使用命令"),n("code",null,"sudo bash vtoyboot.sh"),s("即可，执行成功后关机")],-1),T={href:"https://blog.csdn.net/qq_44073614/article/details/125678356",target:"_blank",rel:"noopener noreferrer"},E=o('<p>然后找到你的vdi保存位置，建议备份一下，然后将文件后缀名改为<code>.vtoy</code>，这里推荐直接在后边加<code>.vtoy</code>，如<code>xxx.vdi.vtoy</code>，备用</p><h2 id="ventoy" tabindex="-1"><a class="header-anchor" href="#ventoy" aria-hidden="true">#</a> Ventoy</h2><p>首先将U盘格式化为NTFS格式，打开Ventoy2Disk</p><figure><img src="https://image.zekee.top/blog/20231103001437.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>选择设备后直接安装即可</p><p>至此，所有准备工作都以完成，现在来完成最终的配置</p><h2 id="最终配置" tabindex="-1"><a class="header-anchor" href="#最终配置" aria-hidden="true">#</a> 最终配置</h2>',7),G={href:"https://www.ventoy.net/cn/doc_news.html",target:"_blank",rel:"noopener noreferrer"},V=o(`<div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function z(U,W){const a=e("ExternalLinkIcon");return i(),u("div",null,[c,r,n("ol",null,[n("li",null,[s("Win10或Win11镜像，这里推荐精简版的，win10精简版可以到"),n("a",d,[s("这里"),t(a)]),s("下载")]),k,n("li",null,[n("a",v,[s("WTG辅助工具"),t(a)])]),n("li",null,[n("a",q,[s("VirtualBox"),t(a)])]),n("li",null,[n("a",m,[s("Ventoy安装程序"),t(a)])]),n("li",null,[n("a",b,[s("vhdboot"),t(a)])]),n("li",null,[n("a",g,[s("vtoyboot"),t(a)])])]),y,n("p",null,[s("剩余的配置项默认就好，如果想进行设置，可以参考"),n("a",_,[s("这里"),t(a)]),s("，之后点击部署即可")]),h,n("p",null,[s("然后就可以启动系统开始安装系统了，安装完成后，将下好的"),f,s("拷贝到虚拟机中，方法很多，"),n("a",w,[s("ftp"),t(a)]),s("，"),n("a",x,[s("共享文件夹"),t(a)]),s("都可以")]),O,n("blockquote",null,[n("p",null,[s("不会解压iso文件的看"),n("a",T,[s("这里"),t(a)]),s(" 当然，还有更简单的，在windows下解压好后直接将sh文件发到虚拟机中")])]),E,n("p",null,[s("配置项里的东西在ventoy官网都有很详细的解释，不懂的可以去"),n("a",G,[s("官网"),t(a)]),s("查看")]),V])}const N=p(l,[["render",z],["__file","使用256G洋垃圾打造3合1移动硬盘.html.vue"]]);export{N as default};
